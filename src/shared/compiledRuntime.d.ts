...
export type CompiledRouterPlan = { id: string; entryNodeId: string; publicModelName: string; enabled: boolean; sourceRef?: RouteProgramSourceRef; metadata?: Record<string, unknown>; runtime?: Record<string, unknown>; affinity: { policy: import('./routeAffinity.js').ResolvedRouteAffinityPolicy; pools: Array<{ id: string; label?: string; executionTargetIds: number[] }> }; filterStages: CompiledRouterFilterStage[]; executionAlternatives: CompiledExecutionAlternative[] };
